...
- **Hit an entity with it** and they go flying — a huge knockback impulse,
  roughly 10 blocks on open ground (less over rough terrain or against
  knockback-resistant mobs, same physics as any other knockback).
